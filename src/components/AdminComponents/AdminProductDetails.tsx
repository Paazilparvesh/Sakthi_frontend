...
import { AccountDetails, Material, ProductType, QaDetails } from "@/types/inward.type";
            ...
            <tbody>
              <>
                <tr className="hover:bg-gray-50 transition-colors text-gray-800">
                  ...
                  <td className="border px-2 py-2">{product.worker_no || "—"}</td>
                  ...
                  <React.Fragment key={index}>
                    <tr className="hover:bg-gray-50 transition-colors text-gray-800">
                      ...
                      <td className="border px-2 py-2">
                        <Button
                          onClick={() =>
                            setSelectedMaterialId(selectedMaterialId === mat.id ? null : mat.id)
                          }
